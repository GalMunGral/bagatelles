...
import { cos, PI, sin, add, sub, cross } from "./matrix.js";
...
requestAnimationFrame(function render() {
    ...
    gl.uniformMatrix4fv(uniformM, false, 
    // prettier-ignore
    [
    ...
    gl.uniformMatrix4fv(uniformV, false, viewMatrix(camera.pos, camera.dir, camera.right));
    gl.uniformMatrix4fv(uniformP, false, projectionMatrix(camera.alpha, 0.1, 100));
